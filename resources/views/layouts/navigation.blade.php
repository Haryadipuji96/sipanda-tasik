...
<div x-show="open" x-transition:enter="mobile-menu-enter" x-transition:enter-start="mobile-menu-enter"
    ...
    <div class="pt-2 pb-3 space-y-1 px-4">
        ...
        <div class="flex items-center space-x-3 px-3 py-4 mb-2 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg text-white shadow-sm">
            @php
                $user = Auth::user();
                $avatar = $user->profile_photo
                    ? asset('profile_photos/' . $user->profile_photo)
            ...
            <img src="{{ $avatar }}" class="w-12 h-12 rounded-full object-cover border-2 border-white shadow-md"
                alt="Foto Profil"
            ...
            <div class="text-left flex-1 min-w-0">
                ...
                <a href="{{ route('profile.edit') }}" class="text-xs text-blue-200 hover:text-white underline mt-1 inline-block">
                    Edit Profile
                </a>
            </div>
        </div>
        ...
        <div x-data="{ open: false }" class="space-y-1">
            ...
            <div x-show="open" x-transition x-cloak class="space-y-1 pl-4 mt-2 border-l-2 border-blue-200 ml-5">
                @canSuperadmin
                ...
                <x-responsive-nav-link :href="route('dosen.index')" class="group">
                    <div class="flex items-center space-x-3 py-2">
                        <div
                            class="w-8 h-8 bg-gradient-to-r from-red-400 to-red-500 rounded-md flex items-center justify-center shadow-sm">
                            <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
