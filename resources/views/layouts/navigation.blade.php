<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div x-data="{ openMaster: false }" class="relative flex items-center">
                        ...
                        <button @click="openMaster = !openMaster"
                            ...
                            <svg class="ml-1 h-4 w-4 transition-transform duration-200"
                                :class="{ 'rotate-180': openMaster }" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <div x-show="openMaster" @click.away="openMaster = false" x-transition
                            class="absolute top-full left-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg">
                    ...
                    <!-- Sarpras (opsional, bisa diaktifkan nanti) -->
                    ...
                    <x-nav-link :href="route('userlogin.index')" :active="request()->routeIs('userlogin.*')">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <!-- Responsive Settings (User Info + Logout) -->
