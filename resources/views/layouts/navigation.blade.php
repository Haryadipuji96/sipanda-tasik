...
<div class="navbar-bg relative" x-data="{ open: false }">
    ...
    <nav class="shadow-md text-white relative z-10" x-data="{ openMaster: false, openSetting: false }">
        ...
        <div :class="{ 'block': open, 'hidden': !open }"
            class="sm:hidden bg-gradient-to-b from-blue-50 to-white text-gray-800 shadow-inner" x-cloak>
            <div class="pt-2 pb-3 space-y-1 px-2">
                ...
                <div x-data="{ open: false }" class="space-y-1">
                    ...
                    <div x-show="open" x-transition x-cloak class="space-y-1 pl-4 mt-2">
                        <x-responsive-nav-link :href="route('fakultas.index')" class="group">
                            <div class="flex items-center space-x-3">
                                <div
                                    class="w-6 h-6 bg-gradient-to-r from-green-400 to-green-500 rounded-md flex items-center justify-center">
                        ...
                        <x-responsive-nav-link :href="route('prodi.index')" class="group">
                            <div class="flex items-center space-x-3">
                                <div
                                    class="w-6 h-6 bg-gradient-to-r from-blue-400 to-blue-500 rounded-md flex items-center justify-center">
                                    <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <x-responsive-nav-link :href="route('kategori-arsip.index')" class="group">
                            <div class="flex items-center space-x-3">
                                <div
                                    class="w-6 h-6 bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-md flex items-center justify-center">
                                    <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <x-responsive-nav-link :href="route('dosen.index')" class="group">
                            <div class="flex items-center space-x-3">
                                <div
                                    class="w-6 h-6 bg-gradient-to-r from-red-400 to-red-500 rounded-md flex items-center justify-center">
                                    <svg class="w-3 h-3 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <x-responsive-nav-link :href="route('arsip.index')" class="group">
                    <div class="flex items-center space-x-3">
                        <div
                            class="w-8 h-8 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-lg flex items-center justify-center">
                            <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <x-responsive-nav-link :href="route('sarpras.index')" class="group">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="font-medium">Data Sarpras</span>
                    </div>
                </x-responsive-nav-link>
                ...
                <x-responsive-nav-link :href="route('tenaga-pendidik.index')" class="group">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="font-medium">Data Tendik</span>
                    </div>
                </x-responsive-nav-link>
                ...
                <x-responsive-nav-link :href="route('userlogin.index')" class="group">
                    <div class="flex items-center space-x-3">
                        <div
                            class="w-8 h-8 bg-gradient-to-r from-cyan-500 to-cyan-600 rounded-lg flex items-center justify-center">
                            <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
