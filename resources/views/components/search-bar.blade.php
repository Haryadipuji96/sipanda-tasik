<form action="{{ route($route) }}" method="GET" class="mb-4" x-data="{ loading: false }" @submit="loading = true">
    <div class="relative w-full max-w-md" id="input">
        ...
        <input type="text" name="search" value="{{ request('search') }}" id="floating_outlined" placeholder="Search..."
            class="block w-full text-sm h-[40px] px-4 text-blue-900 bg-white rounded-lg border border-blue-300 appearance-none 
        ...
        <!-- Icon search -->
        <div class="absolute top-2 right-3 text-blue-400">
