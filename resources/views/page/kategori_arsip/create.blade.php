<x-app-layout>
    <x-slot name="title">Tambah Kategori Arsip</x-slot>
    ...
    <div class="p-4 sm:p-6">
        <div class="max-w-3xl mx-auto">
            <div class="form-section">
                ...
                <div class="form-header">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 class="text-lg sm:text-xl font-semibold">Tambah Kategori Arsip Baru</h1>
                                <p class="text-blue-100 text-xs sm:text-sm mt-1">
                                    Buat kategori baru untuk mengorganisir arsip dokumen
                                </p>
                            </div>
                        </div>
                ...
                <!-- Form -->
                <form action="{{ route('kategori-arsip.store') }}" method="POST" id="kategoriForm">
                    @csrf
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-blue-700 text-xs sm:text-sm">
                                            • Buat kategori untuk mengelompokkan arsip dokumen<br>
                            ...
                            <div class="space-y-4 sm:space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           placeholder="Contoh: Dokumen Akademik, Surat Menyurat, Laporan"
                                           required
                                           maxlength="255">
                                    @error('nama_kategori')
                                ...
                                <div>
                                    ...
                                    <textarea name="deskripsi" 
                                              ...
                                              placeholder="Masukkan deskripsi tentang kategori arsip ini...">{{ old('deskripsi') }}</textarea>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @if (session('success'))
                Swal.fire({
                    ...
                    window.location.href = "{{ route('kategori-arsip.index') }}";
                });
            @endif
