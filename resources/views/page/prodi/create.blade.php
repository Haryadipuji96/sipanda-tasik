                            ...
                            <div class="space-y-4 sm:space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama_prodi" value="{{ old('nama_prodi') }}"
                                        class="w-full border border-gray-300 rounded-lg px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                                        placeholder="Contoh: Teknik Informatika" required maxlength="255">
                                    @error('nama_prodi')
                                        <p class="text-red-500 text-xs sm:text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="jenjang"
                                        ...
                                        <option value="S1" {{ old('jenjang') == 'S1' ? 'selected' : '' }}>S1 -
                                            Sarjana</option>
                                        <option value="S2" {{ old('jenjang') == 'S2' ? 'selected' : '' }}>S2 -
                                            Magister</option>
                                        <option value="S3" {{ old('jenjang') == 'S3' ? 'selected' : '' }}>S3 -
                                            Doktor</option>
                                        <option value="D3" {{ old('jenjang') == 'D3' ? 'selected' : '' }}>D3 -
                                            Diploma</option>
                                        <option value="D4" {{ old('jenjang') == 'D4' ? 'selected' : '' }}>D4 -
                                            Diploma IV</option>
                                        <option value="Prof" {{ old('jenjang') == 'Prof' ? 'selected' : '' }}>Profesi
                                        </option>
                                        <option value="Lainnya" {{ old('jenjang') == 'Lainnya' ? 'selected' : '' }}>
                                            Lainnya</option>
                                    </select>
                                    @error('jenjang')
                                        <p class="text-red-500 text-xs sm:text-sm mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select name="ketua_prodi" class="w-full border rounded px-3 py-2 select2-dosen"
                                        id="ketuaProdiSelect">
                                        ...
                                        @foreach ($dosen as $d)
                                            ...
                                            @endphp
                                            <option value="{{ $d->id }}" {{ old('ketua_prodi') == $d->id ? 'selected' : '' }}>
                                                {{ $namaLengkap }}
                                            </option>
                                        @endforeach
                                    </select>
