                ...
                <form action="{{ route('ruangan.simpan-barang', $ruangan->id) }}" method="POST"
                    ...
                    <div class="mb-6 p-4 bg-green-50 rounded-lg border border-green-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <!-- Nama Barang -->
                            <div>
                                <label class="block font-medium mb-1 text-gray-700">Nama Barang <span
                            ...
                            <!-- Kategori Barang -->
                            <div>
                                <label class="block font-medium mb-1 text-gray-700">Kategori Barang <span
                                        class="text-red-500">*</span></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <!-- Jumlah -->
                            <div>
                                <label class="block font-medium mb-1 text-gray-700">Jumlah <span
                                        class="text-red-500">*</span></label>
                            ...
                            <!-- Satuan -->
                            <div>
                                <label class="block font-medium mb-1 text-gray-700">Satuan <span
                                        class="text-red-500">*</span></label>
                                <select name="satuan"
                                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                                    required>
                            ...
                            <!-- Kondisi -->
                            <div>
                                <label class="block font-medium mb-1 text-gray-700">Kondisi <span
                                        class="text-red-500">*</span></label>
                                <select name="kondisi"
                                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                                    required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <!-- Tanggal Pengadaan -->
                            <div>
                                <label class="block font-medium mb-1 text-gray-700">Tanggal Pengadaan <span
                                        class="text-red-500">*</span></label>
                            ...
                            <!-- Sumber -->
                            <div>
                                <label class="block font-medium mb-1 text-gray-700">Sumber Barang <span
                                        class="text-red-500">*</span></label>
                                <select name="sumber"
                                    class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                                    required>
                        ...
                        <!-- Spesifikasi -->
                        <div class="mb-4">
                            <label class="block font-medium mb-1 text-gray-700">Spesifikasi Barang <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <!-- Kode Seri -->
                            <div>
                                <label class="block font-medium mb-1 text-gray-700">Kode / Seri Barang <span
                                        class="text-red-500">*</span></label>
