<x-app-layout>
    ...
    <div class="p-6">
        <div class="max-w-4xl mx-auto">
            <div class="form-section">
                ...
                <!-- Form -->
                <form action="{{ route('dokumen-mahasiswa.update', $dokumen->id) }}" method="POST"
                    enctype="multipart/form-data" id="dokumenEditForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nim" value="{{ old('nim', $dokumen->nim) }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                ...
                                <div>
                                    ...
                                    <select name="prodi_id"
                                        ...
                                        @foreach ($prodi as $p)
                                            <option value="{{ $p->id }}"
                                                {{ old('prodi_id', $dokumen->prodi_id) == $p->id ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <select name="status_mahasiswa"
                                        ...
                                        <option value="Aktif"
                                            {{ old('status_mahasiswa', $dokumen->status_mahasiswa) == 'Aktif' ? 'selected' : '' }}>
                                            Aktif</option>
                                        <option value="Lulus"
                                            {{ old('status_mahasiswa', $dokumen->status_mahasiswa) == 'Lulus' ? 'selected' : '' }}>
                                            Lulus</option>
                                        <option value="Cuti"
                                            {{ old('status_mahasiswa', $dokumen->status_mahasiswa) == 'Cuti' ? 'selected' : '' }}>
                                            Cuti</option>
                                        <option value="Drop Out"
                                            {{ old('status_mahasiswa', $dokumen->status_mahasiswa) == 'Drop Out' ? 'selected' : '' }}>
                                            Drop Out</option>
                                    </select>
                                        ...
                                        <div class="mb-3">
                                            <div
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <span
                                                        class="text-green-700 text-sm font-medium">{{ $dokumen->file_ijazah }}</span>
                                                </div>
                                            ...
                                            <p class="text-gray-500 text-xs mt-1">Upload file baru untuk mengganti.</p>
                                        </div>
                                    @endif
                                    ...
                                    <div id="ijazahPreview" class="mt-2 hidden">
                                        <div class="flex items-center p-2 bg-blue-50 border border-blue-200 rounded">
                                            ...
                                            <span id="ijazahFileName"
                                                class="text-blue-700 text-sm font-medium"></span>
                                        </div>
                                    </div>
                                    @error('file_ijazah')
                                        ...
                                        <div class="mb-3">
                                            <div
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <span
                                                        class="text-green-700 text-sm font-medium">{{ $dokumen->file_transkrip }}</span>
                                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Validasi semua file input di form edit
            const fileInputs = document.querySelectorAll('#dokumenEditForm input[type="file"]');
            ...
            // Validasi form submit untuk EDIT
            const editForm = document.getElementById('dokumenEditForm');
            if (editForm) {
            ...
            // Drag and drop functionality untuk form edit
            document.querySelectorAll('#dokumenEditForm .file-upload').forEach(area => {
        ...
        // Fungsi preview file yang dipanggil dari HTML
