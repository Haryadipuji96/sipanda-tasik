            ...
            <div class="bg-white shadow-xl rounded-2xl p-6 border border-gray-100">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 pb-4 border-b">
                    <div class="flex items-center space-x-3 mb-3 md:mb-0">
                        ...
                        <div>
                            <h1 class="text-2xl font-semibold text-gray-800">Import Data Mahasiswa</h1>
                            <p class="text-sm text-gray-500">Upload file Excel untuk import data mahasiswa</p>
                        </div>
                    </div>
                    
                    <div class="flex gap-2">
                        <a href="{{ route('dokumen-mahasiswa.download-template') }}" 
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-400 transition-colors">
                    <form action="{{ route('dokumen-mahasiswa.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-gray-500 mb-4">Pilih file Excel yang berisi data mahasiswa</p>
                        </div>
                ...
                <div class="mt-6 bg-red-50 border border-red-200 rounded-xl p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="bg-white border border-red-100 rounded-lg p-4">
                            <p class="font-medium text-red-700">Baris {{ $error->row() }}: {{ $error->errors()[0] }}</p>
                            <p class="text-sm text-gray-600 mt-1">Data: {{ json_encode($error->values()) }}</p>
                        </div>
                        @endforeach
                    </div>
                </div>
