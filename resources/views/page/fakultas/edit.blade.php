<x-app-layout>
                ...
                <div class="form-header">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 class="text-lg sm:text-xl font-semibold">Edit Fakultas</h1>
                                <p class="text-orange-100 text-xs sm:text-sm mt-1">
                                    Perbarui data fakultas dan informasi dekan
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-amber-700 text-xs sm:text-sm">
                                            • Perbarui data fakultas dengan informasi yang valid<br>
                            ...
                            <div class="space-y-4 sm:space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama_fakultas"
                                        ...
                                        placeholder="Contoh: Fakultas Teknik" required maxlength="255">
                                    @error('nama_fakultas')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="dekan" value="{{ old('dekan', $fakultas->dekan) }}"
                                        class="w-full border border-gray-300 rounded-lg px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                                        placeholder="Masukkan nama dekan" maxlength="255">
                                    @error('dekan')
                                        <p class="text-red-500 text-xs sm:text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="deskripsi" rows="4"
                                        ...
                                        placeholder="Masukkan deskripsi singkat tentang fakultas...">{{ old('deskripsi', $fakultas->deskripsi) }}</textarea>
                            ...
                            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="ml-2 font-medium">{{ $fakultas->updated_at->format('d/m/Y H:i') }}</span>
                                    </div>
                                    <div class="flex items-center">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            [namaFakultasInput, dekanInput].forEach(input => {
                if (input) {
