...
{
    // DataSarprasController.php - method index()

    public function index(Request $request)
    {
        // Query untuk ruangan dengan summary
    ...
    public function laporanPDF(Request $request)
    {
        ...
        // Group by ruangan_id - HANYA ruangan yang memiliki barang
        ...
        // Generate nama file yang lebih informatif
    ...
    // Di DataSarprasController - tambahkan method ini
    public function ruanganPDF($id)
    {
        // Ambil data sarpras berdasarkan ruangan_id
        ...
        // Ambil info ruangan dari data pertama
    ...
    public function create()
    {
        ...
        // Data untuk dropdown ruangan existing
        $ruanganAkademik = Ruangan::whereNotNull('id_prodi')
            ->with(['prodi.fakultas'])
            ->get();

        // Ruangan umum (tidak punya prodi atau prodi kosong)
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            // Validasi untuk ruangan existing
            'id_ruangan' => 'nullable|exists:ruangan,id',

            // Validasi untuk ruangan baru
        ...
        try {
            ...
            // Handle file upload
            // Di method store() dan update() - GANTI dengan ini:
            if ($request->hasFile('file_dokumen')) {
                ...
                // Simpan langsung ke public/dokumen_sarpras
    ...
    // DataSarprasController.php - tambahkan method baru

    /**
     * Show detail ruangan dan barang-barangnya
     */
    ...
    /**
     * Form tambah barang ke ruangan tertentu
     */
    ...
    /**
     * Simpan barang ke ruangan tertentu
     */
